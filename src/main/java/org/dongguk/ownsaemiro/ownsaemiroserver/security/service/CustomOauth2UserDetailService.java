...
import org.dongguk.ownsaemiro.ownsaemiroserver.security.info.factory.Oauth2UserInfoFactory;
...
public class CustomOauth2UserDetailService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        UserRepository.UserSecurityForm securityForm = userRepository.findUserSecurityFromBySerialId(oauth2UserInfo.getId())
                .orElseGet(() -> {
